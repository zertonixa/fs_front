            ...
            >
                ...
                <div className={styles.containerBodyMeta}>
                    ...
                    <div className={styles.containerBodyMetaItem}>
                        ...
                        <div className={styles.containerBodyMetaValue}>{report.user_id}</div>
                    </div>
                            ...
                            {report.files.map((file) => (
                                ...
                                >
                                    {isImageFile(file) && file.download_url ? (
                                        ...
                                        <div className={styles.containerBodyPreviewStub}>
                                            FILE
                                        </div>
                                    )}
                ...
                {canEdit ? (
                    <div className={styles.containerBodyEdit}>
                        ...
                        {error && (
                            <div className={styles.containerBodyError}>{error}</div>
                        )}
